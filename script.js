  ...
  (() => {
    ...
    const PROJECTS = [
      ...
      { meta: 'Engineering manager, team of 11, raised $75K', title: 'Spay.LA', body:
        "<h4>The problem</h4><p>A nonprofit needed a real fundraising and advocacy platform, not a template, and someone to carry it from a vague brief to something shipped.</p><h4>The role</h4><p>Pranav led it as engineering manager of a team of 11, owning the full arc: scoping with the client, running the team, and delivering. It raised $75K. <a href=\"https://www.spay.la/\" target=\"_blank\" rel=\"noopener\">spay.la</a></p><h4>What it took</h4><p>The hard part was running a team and a client relationship at the same time, turning a fuzzy ask into a concrete build and keeping eleven people pointed the same direction long enough to ship.</p>" },
    ...
    const LEADS = [
      { meta: 'Co-founder and president', title: 'Real World AI Network (RAIN)', body:
        "<h4>What it is</h4><p>RAIN (Real World AI Network) is a 7,000+ student organization Pranav co-founded, spanning UC San Diego's engineering, data science, and business schools. It exists to push AI research, building, and startups across the whole university, not just one department.</p><h4>The role</h4><p>Co-founder and president. At that scale it is its own engineering problem: programming, partnerships, and a community big enough that the crowd around a problem matters as much as the problem. <a href=\"https://rain.ucsd.edu\" target=\"_blank\" rel=\"noopener\">rain.ucsd.edu</a></p>" },
      ...
      { meta: 'President', title: 'CSE Society @ UCSD', body:
        "<h4>What it is</h4><p>UC San Diego's oldest computing organization, 100+ members, running career fairs, conferences, talks, and a research journal, with open-source partnerships with the Linux Foundation and Cisco.</p><h4>The role</h4><p>President. The institutional-backbone version of community building: keeping a decades-old org useful to current students while plugging it into the wider open-source and industry world. <a href=\"https://csesucsd.com\" target=\"_blank\" rel=\"noopener\">csesucsd.com</a></p>" },
